...
PACKAGE ?= helm-kyverno
XRD_DIR := apis/kyvernos
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/kyvernos/standard.yaml
...
EXAMPLES := \
    examples/kyvernos/minimal.yaml:: \
    examples/kyvernos/standard.yaml::
...
render\:%:
	@example="examples/kyvernos/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
